    ...
    <Flex overflow="hidden" flex="1 1 auto" h="100%">
      {
        ...
        <Box minW={380} w={380} flexShrink={0} minH="calc(100vh - 66px)">
          <Box position="relative" borderRight={`1px solid ${borderColor}`} minW="100%" minH="calc(100vh - 66px)">
            <Box px={3} py={2}>
                            ...
                            <ListItem>
                              <Box my={4}>
                                ...
                                <Box
                                  ...
                                  ml="2"
                                >
                                  {episode.videoTime} &bull; episódio {episode.order}
                                </Box>                           
                              </Box>
                            </ListItem>
                          ))
      ...
      <Flex flexGrow={1} direction="column" h="100%" overflowY="auto" flexGrow={1}>
        <Flex overflow="hidden" w="100%" bgColor="#000" minHeight={'60vh'} justifyContent="center">
          {
            currentEpisode &&
            <iframe
              ...
              width="100%"
              height="100%"
              style={{maxWidth: 1200,  minHeight: '60vh', height: '100%', width: '100%'}}
            />
          }
        </Flex>
        <Box p={3}>
