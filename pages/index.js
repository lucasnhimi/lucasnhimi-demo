import { Heading, Button, Flex, Text, Box, Badge, Image, Code, SimpleGrid, useColorModeValue } from '@chakra-ui/react';
    ...
    <Layout>  
      <Box bgColor={bg}>
        <Flex justifyContent="center" alignItems="center" py={20} >  
          <Flex px={12} py={20} w="full" maxW="1200px" direction="column" alignItems="center">
            <Box mb={4}>
